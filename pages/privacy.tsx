            ...
            <div className="items-center flex flex-wrap">
              <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                <div className="pr-12">
                  ...
                  <p className="mt-4 text-4xl text-blueGray-200">Privacy Policy</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section id="news" className="pb-20 bg-blueGray-200 -mt-24">
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap items-center mt-32">
              <div className="w-full px-4 mr-auto ml-auto">
                <h1 className="text-4xl mb-2 font-semibold leading-normal">Privacy Policy</h1>
                <h3 className="text-lg mb-2 font-semibold leading-normal">Last updated: June 29, 2021</h3>
                <p className="text-lg leading-relaxed mt-4 mb-4">
                  This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of
                  Your information when You use the Service and tells You about Your privacy rights and how the law
                  protects You.
                </p>
                <p className="text-lg leading-relaxres enteed mt-0 mb-4">
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap items-center">
              <div className="w-full px-4 mr-auto ml-auto">
                <h1 className="text-4xl mb-2 font-semibold leading-normal">Interpretation and Definitions</h1>
                <h1 className="text-2xl mb-2 font-semibold leading-normal">Interpretation</h1>
                <p className="text-lg leading-relaxed mt-4 mb-4">
                ...
                <h1 className="text-2xl mb-2 font-semibold leading-normal">Definitions</h1>
                <p className="text-lg leading-relaxed mt-4 mb-4">
                  ...
                  <ul>
                    ...
                    <li className="pl-3 mt-2">
                      ...
                      Agreement) refers to Monday Night Hunts.
                    </li>
                    <li className="pl-3 mt-2">
                    ...
                    <li className="pl-3 mt-2">
                      <strong>Website</strong> refers to Bayou Bowl, accessible from https://bayoubowl.gg
                    </li>
                    <li className="pl-3 mt-2">
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap items-center">
              <div className="w-full px-4 mr-auto ml-auto">
                <h1 className="text-4xl mb-2 font-semibold leading-normal">Collecting and Using Your Personal Data</h1>
                <h1 className="text-3xl mb-2 font-semibold leading-normal">Types of Data Collected</h1>
                <h3 className="text-xl mb-2 font-semibold leading-normal">Personal Data</h3>
                <p className="text-lg leading-relaxed mt-4 mb-4">
                  While using Our Service, We may ask You to provide Us with certain personally identifiable information
                  that can be used to contact or identify You. Personally identifiable information may include, but is
                  not limited to:
                  <ul>
                    <li className="pl-3 mt-2">- Email address</li>
                    <li className="pl-3 mt-2">- First and last name</li>
                    <li className="pl-3 mt-2">- Usage data</li>
                    <li className="pl-3 mt-2">- Third-party Social Media Service data</li>
                  </ul>
                </p>
                <h3 className="text-xl mb-2 font-semibold leading-normal">Usage Data</h3>
                <p className="text-lg leading-relaxed mt-4 mb-4">
                ...
                <ul>
                  <li className="pl-3 mt-2">- Google</li>
                </ul>
                <p className="text-lg leading-relaxed mt-4 mb-4">
                ...
                <h3 className="text-xl mb-2 font-semibold leading-normal">Tracking Technologies and Cookies</h3>
                <p className="text-lg leading-relaxed mt-4 mb-4">
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap items-center">
              <div className="w-full px-4 mr-auto ml-auto">
                <h1 className="text-4xl mb-2 font-semibold leading-normal">Use of Your Personal Data</h1>
                <p className="text-lg leading-relaxed mt-4 mb-4">
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap items-center">
              <div className="w-full px-4 mr-auto ml-auto">
                <h1 className="text-4xl mb-2 font-semibold leading-normal">Retention of Your Personal Data</h1>
                <p className="text-lg leading-relaxed mt-4 mb-4">
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap items-center">
              <div className="w-full px-4 mr-auto ml-auto">
                <h1 className="text-4xl mb-2 font-semibold leading-normal">Transfer of Your Personal Data</h1>
                <p className="text-lg leading-relaxed mt-4 mb-4">
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap items-center">
              <div className="w-full px-4 mr-auto ml-auto">
                <h1 className="text-4xl mb-2 font-semibold leading-normal">Disclosure of Your Personal Data</h1>
                <h3 className="text-lg mb-2 font-semibold leading-normal">Business Transactions</h3>
                <p className="text-lg leading-relaxed mt-4 mb-4">
                ...
                <h3 className="text-lg mb-2 font-semibold leading-normal">Law Enforcement</h3>
                <p className="text-lg leading-relaxed mt-4 mb-4">
                ...
                <h3 className="text-lg mb-2 font-semibold leading-normal">Other Legal Requirements</h3>
                <p className="text-lg leading-relaxed mt-4 mb-4">
                  The Company may disclose Your Personal Data in the good faith belief that such action is necessary to:
                  <ul>
                    <li className="pl-3 mt-2">- Comply with a legal obligation</li>
                    <li className="pl-3 mt-2">- Protect and defend the rights or property of the Company</li>
                    <li className="pl-3 mt-2">
                      - Prevent or investigate possible wrongdoing in connection with the Service
                    </li>
                    <li className="pl-3 mt-2">- Protect the personal safety of Users of the Service or the public</li>
                    <li className="pl-3 mt-2">- Protect against legal liability</li>
                  </ul>
                </p>
                <h1 className="text-4xl mb-2 font-semibold leading-normal">Security of Your Personal Data</h1>
                <p className="text-lg leading-relaxed mt-4 mb-4">
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap items-center">
              <div className="w-full px-4 mr-auto ml-auto">
                <h1 className="text-4xl mb-2 font-semibold leading-normal">Children's Privacy</h1>
                <p className="text-lg leading-relaxed mt-4 mb-4">
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap items-center">
              <div className="w-full px-4 mr-auto ml-auto">
                <h1 className="text-4xl mb-2 font-semibold leading-normal">Links to Other Websites</h1>
                <p className="text-lg leading-relaxed mt-4 mb-4">
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap items-center">
              <div className="w-full px-4 mr-auto ml-auto">
                <h1 className="text-4xl mb-2 font-semibold leading-normal">Changes to this Privacy Policy</h1>
                <p className="text-lg leading-relaxed mt-4 mb-4">
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap items-center">
              <div className="w-full px-4 mr-auto ml-auto">
                <h1 className="text-4xl mb-2 font-semibold leading-normal">Contact Us</h1>
                <p className="text-lg leading-relaxed mt-4 mb-4">
                  If you have any questions about this Privacy Policy, You can contact us:
                  <ul>
                    <li className="pl-3 mt-2">- By email: contact@mnh.gg</li>
                  </ul>
                </p>
              </div>
            </div>
