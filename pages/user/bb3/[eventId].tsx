...
//                                             Money Earned
//                                         </label>
//                                         <input id={currentUser.id + '-money'} type="number" min={0} defaultValue={0} className="w-full" onChange={() => { }} />
//                                     </div>
//                                 </div>
//                                 <div className="w-full px-4">
//                                     <div className="relative w-full mb-3">
...
//                                             Kills
//                                         </label>
//                                         <input id={currentUser.id + '-kills'} type="number" min={0} max={9} defaultValue={0} className="w-full" onChange={() => { }} />
//                                     </div>
//                                 </div>
//                                 <div className="w-full px-4">
//                                     <div className="relative w-full mb-3">
//                                         <label className="block uppercase text-blueGray-600 text-xs font-bold mb-2" >
//                                         {"Soul Survivor: "}<input id={currentUser.id + '-survivor'} type="checkbox" defaultValue={0} className="" onChange={() => { }} />
//                                         </label>
//                                     </div>
//                                 </div>
//                             </div>
