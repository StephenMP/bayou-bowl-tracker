      ...
      data: {
        ...
        team_score: {
          create: {
            ...
            hunt_dollars: eventScore.team_score.hunt_dollars,
            survived: eventScore.team_score.survived,
          },
        },
      },
    })
...
export async function readEventScoresForTeam(
  teamId: string,
  opts: EventScoreReadOpts = DefaultReadOpts
): Promise<EventScore[]> {
...
export async function readEventScoresForEvent(
  eventId: string,
  opts: EventScoreReadOpts = DefaultReadOpts
): Promise<EventScore[]> {
  return await client().findMany({
