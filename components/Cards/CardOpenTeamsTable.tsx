...
function AllTeams({ color }) {
  ...
  const { teams, isLoading } = useTeamsForEvent('a0f7848a-d1c2-456c-a0ce-47ea0873b8dc', { suspense: false })
...
export default function CardOpenTeamsTable({ color }) {
  return (
...
CardOpenTeamsTable.defaultProps = {
  color: "light",
};

CardOpenTeamsTable.propTypes = {
